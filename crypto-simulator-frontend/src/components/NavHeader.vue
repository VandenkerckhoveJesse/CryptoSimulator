<template>
    <nav class="bg-bg-3 sticky-top py-4 py-lg-7">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-3 aos-init aos-animate" data-aos="fade-down" data-aos-delay="0">
                        <a class="btn btn-width-equal-height d-lg-none rounded-circle custom-mobile-nav-btn" data-bs-toggle="offcanvas" data-bs-target="#hidden-nav">
                    ...
                    <div class="col-6 text-center aos-init aos-animate" data-aos="fade-down" data-aos-delay="250">
                        <router-link to="/">
                            <img src="../assets/logo.png" srcset="i/logo-dark@2x.png 2x" alt="" class="img-fluid aos-init aos-animate" data-aos="fade-down" data-aos-delay="0">
                        </router-link>
                    </div>
        ...
        <div class="offcanvas offcanvas-start bg-bg-3" id="hidden-nav" aria-hidden="true">
            <div class="offcanvas-header">
                <router-link to="/">
                    <img src="../assets/logo.png" srcset="i/logo-dark@2x.png 2x" alt="" class="img-fluid">
                </router-link>
            ...
            <div class="offcanvas-body">
                <div>
                    <router-link v-if="!isAuthenticated" to="login" class="fw-bold py-2 d-inline-block">
                        Sign In
                    </router-link>
                </div>
                <router-link v-if="!isAuthenticated" to="signup" class="btn btn-sm btn-action-1 rounded-2 mt-4">
                    Sign Up
                </router-link>
                <router-link v-else to="portfolio" class="btn btn-sm btn-action-1 rounded-2 mt-4">
                    Portfolio
                </router-link>
            </div>
        </div>
        <div class="d-none d-lg-block">
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-2">
                        <router-link to="/">
                            <img src="../assets/logo.png" alt="" class="img-fluid aos-init aos-animate" data-aos="fade-down" data-aos-delay="0">
                        </router-link>
                    </div>
                    <div  class="d-flex align-items-center justify-content-end col-lg-3">

                        <router-link v-if="!isAuthenticated" to="login" class="fw-bold fs-4 me-8 aos-init aos-animate" data-aos="fade-down" data-aos-delay="650">
                            Sign In
                        </router-link>
                        <router-link v-if="!isAuthenticated" to="signup" class="btn btn-sm btn-action-1 rounded-2 aos-init aos-animate" data-aos="fade-down" data-aos-delay="750">
                            Sign Up
                        </router-link>
                        <router-link v-else to="portfolio" class="btn btn-sm btn-action-1 rounded-2 aos-init aos-animate" data-aos="fade-down" data-aos-delay="750">
                          Portfolio
                        </router-link>
                    </div>
