<template>
    <nav class="bg-bg-3 sticky-top py-4 py-lg-7">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-3 aos-init aos-animate" data-aos="fade-down" data-aos-delay="0">
                        <a class="btn btn-width-equal-height d-lg-none rounded-circle custom-mobile-nav-btn" data-bs-toggle="offcanvas" data-bs-target="#custom-id-9zzwpayo">
                    ...
                    <div class="col-6 text-center aos-init aos-animate" data-aos="fade-down" data-aos-delay="250">
                        <a href="https://designmodo.com/startup/app/preview.php?id=14661#">
        ...
        <div class="offcanvas offcanvas-start bg-bg-3" id="custom-id-9zzwpayo" aria-hidden="true">
            ...
            <div class="offcanvas-body">
                <div>
                    <a href="https://designmodo.com/startup/app/preview.php?id=14661#" class="fw-bold py-2 d-inline-block">
                        Sign In
                    </a>
                </div>
                <a href="https://designmodo.com/startup/app/preview.php?id=14661#" class="btn btn-sm btn-action-1 rounded-2 mt-4">
                    Sign Up
                </a>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center justify-content-end col-lg-3">
                        <a href="https://designmodo.com/startup/app/preview.php?id=14661#" class="fw-bold fs-4 me-8 aos-init aos-animate" data-aos="fade-down" data-aos-delay="650">
                            Sign In
                        </a>
                        <a href="https://designmodo.com/startup/app/preview.php?id=14661#" class="btn btn-sm btn-action-1 rounded-2 aos-init aos-animate" data-aos="fade-down" data-aos-delay="750">
                            Sign Up
                        </a>
                    </div>
                </div>
